---
layout: post
title: "SSTV Tx/Rx with a Pi and an RTL-SDR"
---
...
<img src="/assets/images/rpitx_sstv/gqrx_view.jpg" alt="GQRX Setup" class="full">
...
<img src="/assets/images/rpitx_sstv/qsstv_sound_config.jpg" alt="QSSTV Sound Configuration" class="full">


2\. Go back to the main QSSTV screen. Configure your SSTV settings to match the
    image below.
   
<img src="/assets/images/rpitx_sstv/qsstv_sstv_config.jpg" alt="SSTV Configuration">
...
<img src="/assets/images/rpitx_sstv/qsstv_decoded_image.jpg" alt="QSSTV Decoded Image" class="full">
...
<source src="/assets/video/rpitx_sstv/qsstv_demo.webm" type="video/webm">
<source src="/assets/video/rpitx_sstv/qsstv_demo.mp4" type="video/mp4">
